...
const courses = [
  ...
  { id: 4, title: "Data Analytics", duration: "90 Days", price: "25,000", image: img8 },
  ...
  { id: 12, title: "Node JS Developer", duration: "90 Days", price: "15,000", image: img7 },
        ...
        <div className="course-card" key={course.id}>
          <div className="main-part1">
            <div className={`placement-badge ${index < 3 ? "badge-assurance" : "badge-assistance"}`}>
              {index < 3 ? "100% IT Job Assurance" : "100% IT Job Assistance"}
            </div>
          ...
          <div className="main-part">
            ...
            <FontAwesomeIcon icon={faCreditCard} className="emi-icon" />
              {course.duration === "90 Days" || course.duration === "120 Days"
                ? "3 Months No Cost EMI"
                : "2 Months No Cost EMI"}
            </div>
